...
INSERT INTO "new_Provider" ("createdAt", "email", "id", "locationId", "name", "password", "photo", "serviceId", "starAverage", "text") SELECT "createdAt", "email", "id", "locationId", "name", "password", "photo", "serviceId", "starAverage", "text" FROM "Provider";
DROP TABLE "Provider";
...
INSERT INTO "new_Client" ("createdAt", "email", "id", "locationId", "name", "password", "photo", "text") SELECT "createdAt", "email", "id", "locationId", "name", "password", "photo", "text" FROM "Client";
DROP TABLE "Client";
